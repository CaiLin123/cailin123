package zuoye.test.main;

import org.dom4j.DocumentException;
import zuoye.test.constant.Website;
import zuoye.test.data.Data;
import zuoye.test.instance.Person;
import zuoye.test.tool.Input;
import zuoye.test.tool.Threads;
import zuoye.test.uRL.URLFind;
            ...
            switch (chooce) {
                ...
                case 2:
                    ...
                    while (true) {
                        ...
                        person = input.login(name1, possWord1);
                        if (person != null) {
                            break;
                        }
                    }
